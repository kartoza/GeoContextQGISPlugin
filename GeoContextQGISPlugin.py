...
class GeoContextQGISPlugin:
    ...
    def point_request_panel(self, x, y, registry, key, api_url):
        ...
        try:
            #access_token = ''
            #endpoint_url = ''
            #client = ApiClient(access_token, endpoint_url)
