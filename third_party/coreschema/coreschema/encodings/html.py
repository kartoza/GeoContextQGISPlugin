...
from coreschema.coreschema import Object, Array, String, Integer, Number, Boolean, Enum
import jinja2


env = jinja2.Environment(loader=jinja2.PackageLoader('coreschema.coreschema', 'templates'))
