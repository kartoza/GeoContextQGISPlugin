...
class TestGeocontextMethods(unittest.TestCase):
    ...
    def test_process_points_layer(self):
        ...
        layer_point = duplicate_layer(DATA_TEST_DIR + "/wgs84/points_wgs84.gpkg", "Point")
        ...
        layer_point = duplicate_layer(DATA_TEST_DIR + "/projected/points_multipoint_lo19.gpkg", "Point")
        ...
        layer_point = duplicate_layer(DATA_TEST_DIR + "/wgs84/points_wgs84_broken_geom.gpkg", "Point")
