...
The plugin or changes to the plugin can be tested using Github Actions (https:///github.com//kartoza//GeoContextQGISPlugin//actions).
...
3. Click Run workflow;
   ...
   .. image:: /images/testing/github_actions.png
      :align: center
...
Failed:
   ...
   .. image:: /images/testing/failed.png
      :align: center

Success:

   .. image:: /images/testing/success.png
      :align: center
...
3. The user will be presented with the job steps. Select the job which failed (e.g. 'Run test suite');
   ...
   .. image:: /images/testing/job_steps.png
      :align: center

4. A list of print lines will be shown, with the error at the end;

   .. image:: /images/testing/error_msg.png
      :align: center
...
There should be no issue if the tests does not fail. The jobs will be similar to the following:
   ...
   .. image:: /images/testing/jobs_success.png
      :align: center
...
2. Click on the Tags tab;
   ...
   .. image:: /images/testing/docker_qgis_repo.png
      :align: center
...
4. Copy the 'release-version' characters. 'release-3_20' for the QGIS version 3.20 in this example:
   ...
   .. image:: /images/testing/docker_tag.png
      :align: center
...
2. Click on the edit button (highlighted in red):
   ...
   .. image:: /images/testing/edit_button.png
      :align: center

3. Add the copied tag to the 'qgis_version_tag' list:

   .. image:: /images/testing/tag_jobs.png
      :align: center
